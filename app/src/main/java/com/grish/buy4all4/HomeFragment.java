...
import com.grish.buy4all4.databinding.FragmentHomeBinding;
...
public class HomeFragment extends Fragment {
    ...
    private void setupCategoryRecyclerView() {
        List<String> categories = Arrays.asList(getString(R.string.all1), getString(R.string.sport1), getString(R.string.gadgets1), getString(R.string.car), getString(R.string.realty), getString(R.string.electronics), getString(R.string.health), getString(R.string.other));
    ...
    private void showFilterDialog() {
        ...
        minPriceInput.setHint(R.string.min_price);
        ...
        maxPriceInput.setHint(R.string.max_price);
