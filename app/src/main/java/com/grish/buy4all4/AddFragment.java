...
import com.grish.buy4all4.databinding.FragmentAddBinding;
...
public class AddFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        List<String> categories = Arrays.asList(getString(R.string.sport1), getString(R.string.gadgets1), getString(R.string.car), getString(R.string.realty), getString(R.string.electronics), getString(R.string.health), getString(R.string.other));
