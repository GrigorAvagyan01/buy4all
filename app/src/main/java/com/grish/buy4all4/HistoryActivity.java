...
import com.grish.buy4all4.databinding.ActivityHistoryBinding;
    ...
    private void clearHistory() {
        ...
        db.collection("users")
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    ...
                    filteredHistoryList.clear();
                    adapter.notifyDataSetChanged();
                    Log.d("HistoryActivity", "History cleared");
                })
                .addOnFailureListener(e -> Log.e("HistoryActivity", "Error clearing history", e));
    }
